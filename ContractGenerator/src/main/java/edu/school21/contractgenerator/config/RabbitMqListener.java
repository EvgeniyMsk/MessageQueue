package edu.school21.contractgenerator.config;

import com.google.gson.Gson;
import com.itextpdf.text.*;
import com.itextpdf.text.pdf.BaseFont;
import com.itextpdf.text.pdf.PdfWriter;
import edu.school21.contractgenerator.entity.Person;
...
public class RabbitMqListener {
    ...
    public void grant_other_documents(String message) throws DocumentException, IOException {
        ...
        logger.info("Received from grant_contracts: " + person.getCourse());
    ...
    private void createGuaranteeLetter(Person person) throws DocumentException, IOException {
        ...
        PdfWriter.getInstance(document,
                new FileOutputStream(String.format("%s%s%s/Contract.pdf",
                        PATH,
                        person.getLastName(),
                        person.getName())));
        document.open();
        ...
        String main = String.format("Это Ваш Contract, %s %s!\n" +
                "Ваш возраст: %d\n" +

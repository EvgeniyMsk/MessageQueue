package edu.school21.grantapplicationgenerator.config;

import com.google.gson.Gson;
import com.itextpdf.text.*;
import com.itextpdf.text.pdf.BaseFont;
import com.itextpdf.text.pdf.PdfWriter;
import edu.school21.grantapplicationgenerator.entity.Person;
...
public class RabbitMqListener {
    ...
    private void createGuaranteeLetter(Person person) throws DocumentException, IOException {
        ...
        PdfWriter.getInstance(document,
                new FileOutputStream(String.format("%s%s%s/GrantLetter.pdf",
                PATH,
                person.getLastName(),
                person.getName())));
        document.open();
        ...
        String main = String.format("Это Ваше GrantLetter, %s %s!\n" +
                "Ваш возраст: %d\n" +
